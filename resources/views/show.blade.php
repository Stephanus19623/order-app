...
<body>
    <div x-data="{ open: false }" class="relative min-h-screen">
        ...
        <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:calc(100vh - 5rem);padding:1rem;">
            ...
            <!-- Tombol Order Now -->
            <a href="{{ route('order.now') }}" class="btn-main" style="display:inline-block; text-align:center;">
                Order Now
            </a>
            ...
            <a href="{{ route('invoice.check') }}" class="btn-secondary" style="display:inline-block; text-align:center;">
                Invoice Check
            </a>
        </div>
    </div>
